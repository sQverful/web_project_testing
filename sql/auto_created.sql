...
CREATE TABLE IF NOT EXISTS `testing`.`role` (
  `id` INT NOT NULL,
  `role` ENUM('ADMIN', 'STUDENT') NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `testing`.`test` (
  ...
  `complexity` INT NULL DEFAULT NULL,
  `requests_quantity` INT NULL DEFAULT NULL,
  `blocked` TINYINT(1) NOT NULL,
  `timer` INT NOT NULL,
  `description_ua` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `testing`.`question` (
  `id` INT NOT NULL,
  `question_ua` VARCHAR(255) NULL DEFAULT NULL,
  `question_en` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `testing`.`answer` (
  `id` INT NOT NULL,
  `answer_ua` VARCHAR(255) NULL DEFAULT NULL,
  `answer_en` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `testing`.`subject` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name_ua` VARCHAR(255) NULL DEFAULT NULL,
