    ...
    <div class="alert alert-success" role="alert">
        ...
        <p class="mb-0">
            ...
            Please, check your result in <a class="alert-link"
                                            href="${pageContext.request.contextPath}/controller?command=testPage&id=${testResult.testId}">Results
            tab</a>
        </p>
    </div>
</c:if>
...
<c:if test="${updateRegisterInfoFail}">
    <%@ include file="WEB-INF/jsp/user-navbar.jsp" %>
    <div class="alert alert-danger" role="alert">
        <h4 class="alert-heading h4">Please fill in all params correctly and try again.</h4>
    </div>
</c:if>

<c:if test="${updateRegisterInfoSuccess}">
    <%@ include file="WEB-INF/jsp/user-navbar.jsp" %>
    <div class="alert alert-success" role="alert">
        <h4 class="alert-heading h4">Successfully updated!</h4>
        <br>
        <a class="alert-link" href="${pageContext.request.contextPath}/controller?command=userProfile">My profile</a>
    </div>
</c:if>
